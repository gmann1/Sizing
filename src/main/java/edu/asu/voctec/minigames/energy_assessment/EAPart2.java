...
public class EAPart2 extends GameTemplate
{
	...
	private String[] hintArray = { "There is at least 2 CFLs", "There is at least 1 LED",
	...
	private int lc;
	public static int locationArray[][] = { { 145, 175 }, { 255, 175 }, { 365, 175 },
			{ 200, 285 }, { 310, 285 } };
	
	public static int initialArray[][] = { { 25, 475 }, { 135, 475 }, { 245, 475 },
			{ 355, 475 }, { 465, 475 } };
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException
	{
		...
		BasicComponent square1 = new BasicComponent(SQUARE, locationArray[0][0],
				locationArray[0][1]);
		BasicComponent square2 = new BasicComponent(SQUARE, locationArray[1][0],
				locationArray[1][1]);
		BasicComponent square3 = new BasicComponent(SQUARE, locationArray[2][0],
				locationArray[2][1]);
		BasicComponent square4 = new BasicComponent(SQUARE, locationArray[3][0],
				locationArray[3][1]);
		BasicComponent square5 = new BasicComponent(SQUARE, locationArray[4][0],
				locationArray[4][1]);
		...
		// appliances Plate
		BasicComponent cfl = new BasicComponent(SQUARE, initialArray[0][0],
				initialArray[0][1]);
		BasicComponent led = new BasicComponent(SQUARE, initialArray[1][0],
				initialArray[1][1]);
		BasicComponent radio = new BasicComponent(SQUARE, initialArray[2][0],
				initialArray[2][1]);
		BasicComponent telivision = new BasicComponent(SQUARE, initialArray[3][0],
				initialArray[3][1]);
		BasicComponent laptop = new BasicComponent(SQUARE, initialArray[4][0],
				initialArray[4][1]);
		...
		// Instructions Text
		instructionBox
				.setText("Drag the different appliances to the boxes to meet the target power rating.");
		...
		initialObjects.add(new InitialObjects(new Image(TELIVISION), 355, 475, this, 4,
				60));
		...
		/*
		 * Button testButton = new Button(new Image(STARTSQUARE), 750, 550, new
		 * Rectangle(0, 0, 50, 25), "Testing"); testButton.addActionListener(new
		 * TransitionButtonListener(EAPart1.class)); this.addComponent(testButton);
		 */
	}
			...
			throws SlickException
	{
		...
		if (!nextState)
		{
			...
			if (lc == 5)
			{
				try
				{
					...
					Game.getCurrentGame().addState(new CDIntroScreen(),
		...
		if (continueGood)
		{
			...
			{
				sequenceStep = initiateStars(getScore(hintsUsed, attemptsUsed),
						sequenceStep);
			}
		}
	}
			...
			throws SlickException
	{
		...
		// graphics.drawImage(new
		// Image(applianceImage[v][0]),applianceArray[v][1],applianceArray[v][2]);
	}
		...
		protected void actionPerformed()
		{
			if (continueGood == true)
			{
				try
				{
					Game.updateExitText(
							"Good Job!",
							"You have successfully found a combination of items that meet the target power consumtion.",
							new Image(EA_END_BACKGROUND));
	...
	{
		TextAreaX targetPower = new TextAreaX(new Rectangle(425, 400, 200, 100), 0.95f,
				"Target: " + targetPowerRating + " Watts");
	...
	{
		TextAreaX watt1 = new TextAreaX(new Rectangle(initialArray[0][0],
				initialArray[0][1] + 90, 100, 50), 0.95f, powerRatings[0] + " Watt");
		watt1.setFontSize(16);
		watt1.setFontColor(Color.white);
		this.addComponent(watt1);
		
		TextAreaX watt2 = new TextAreaX(new Rectangle(initialArray[1][0],
				initialArray[1][1] + 90, 100, 50), 0.95f, powerRatings[1] + " Watt");
		watt2.setFontSize(16);
		watt2.setFontColor(Color.white);
		this.addComponent(watt2);
		
		TextAreaX watt3 = new TextAreaX(new Rectangle(initialArray[2][0],
				initialArray[2][1] + 90, 100, 50), 0.95f, powerRatings[2] + " Watt");
		watt3.setFontSize(16);
		watt3.setFontColor(Color.white);
		this.addComponent(watt3);
		
		TextAreaX watt4 = new TextAreaX(new Rectangle(initialArray[3][0],
				initialArray[3][1] + 90, 100, 50), 0.95f, powerRatings[3] + " Watt");
		watt4.setFontSize(16);
		watt4.setFontColor(Color.white);
		this.addComponent(watt4);
		
		TextAreaX watt5 = new TextAreaX(new Rectangle(initialArray[4][0],
				initialArray[4][1] + 90, 100, 50), 0.95f, powerRatings[4] + " Watt");
	...
	{
		TextAreaX name1 = new TextAreaX(new Rectangle(initialArray[0][0],
				initialArray[0][1] - 25, 200, 50), 0.95f, applianceNames[0]);
		name1.setFontSize(16);
		name1.setFontColor(Color.white);
		this.addComponent(name1);
		
		TextAreaX name2 = new TextAreaX(new Rectangle(initialArray[1][0],
				initialArray[1][1] - 25, 200, 50), 0.95f, applianceNames[1]);
		name2.setFontSize(16);
		name2.setFontColor(Color.white);
		this.addComponent(name2);
		
		TextAreaX name3 = new TextAreaX(new Rectangle(initialArray[2][0],
				initialArray[2][1] - 25, 200, 50), 0.95f, applianceNames[2]);
		name3.setFontSize(16);
		name3.setFontColor(Color.white);
		this.addComponent(name3);
		
		TextAreaX name4 = new TextAreaX(new Rectangle(initialArray[3][0],
				initialArray[3][1] - 25, 200, 50), 0.95f, applianceNames[3]);
		name4.setFontSize(16);
		name4.setFontColor(Color.white);
		this.addComponent(name4);
		
		TextAreaX name5 = new TextAreaX(new Rectangle(initialArray[4][0],
				initialArray[4][1] - 25, 200, 50), 0.95f, applianceNames[4]);
