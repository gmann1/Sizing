...
public class Battery extends BatteryControl{
	...
	//public static final String TwoLines = "resources/default/img/minigames/BatterySizing/TwoLines.png";
	//public static Image newImage = new Image(TwoLines);
    ...
    private BatteryGameScreen gameWorld;
    ...
    private void calculateSystemVoltage()
    {
        if(batteryArray.isEmpty())
    ...
    private boolean allParallelsHaveSameVoltage()
    {
        for(int indexInSeries = 0; indexInSeries < batteryArray.size(); indexInSeries++)
        {
    ...
    private boolean allSeriesHaveSameCapacity()
    {
    ...
    private int getTotalCapacity(ArrayList<Battery> testedBatteryArray)
    {
        int totalCapacity = 0;
