...
public class EAPart1ScoreScreen extends GUI
{
			...
			throws SlickException
	{
		...
		congratulation2 = new TextArea(textLocation2, 0.95f,"You have successfully determined the correct order for the different processes needed to determine the correct daily energy requirements.");
		...
		// Start Button
		Button startButton = new Button(new Image(ARROW_RIGHT), 750, 550,new Rectangle(0, 0, 50, 25), "Next");
