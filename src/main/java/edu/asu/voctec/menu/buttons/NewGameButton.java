...
public class NewGameButton extends TransitionButton implements GameDefaults
{
	 ...
	 * 
	 * @param relativeX
	 *            x-location of this button relative to it's container
	 * @param relativeY
	 *            y-location of this button relative to it's container
	 * @throws SlickException
	 *             Indicates a failure to load the button's image
	 * 
	 * @see #NewGameButton(Point)
	 */
	public NewGameButton(int relativeX, int relativeY,
	 ...
	 */
	public NewGameButton(Point relativeLocation, LayoutOption... layoutOptions)
			throws SlickException
	{
	 ...
	 * 
	 * @param imagePath
	 *            path to load this button's image
	 * @param relativeLocation
	 *            location of this button relative to it's container
	 * @throws SlickException
	 *             Indicates a failure to load the image
	 ...
	 */
	public NewGameButton(String imagePath, Point relativeLocation,
			LayoutOption... layoutOptions) throws SlickException
	{
		super(imagePath, relativeLocation.x, relativeLocation.y,
