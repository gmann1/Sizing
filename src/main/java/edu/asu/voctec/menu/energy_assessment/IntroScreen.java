...
public class IntroScreen extends Menu
{
			...
			throws SlickException
	{
		...
		int width = 400;
		int height = 35;
		TrueTypeFont font = new TrueTypeFont(TranslatableLabel.DEFAULT_AWT_FONT.deriveFont(20f), 
				Fonts.ANTI_ALLIAS, Dictionary.getExtraCharacters());
		
		// Add Labels
		addLabel(new TranslatableLabel(Labels.CriticalDesignMonth.instructionsLine1, 
				font, textLeft, yStart, width, height));
		addLabel(new TranslatableLabel(Labels.CriticalDesignMonth.instructionsLine2, 
				font, textLeft, yStart + 2*yDelta, width, height));
		addLabel(new TranslatableLabel(Labels.CriticalDesignMonth.instructionsLine3, 
				font, textLeft, yStart + 3*yDelta, width, height));
		addLabel(new TranslatableLabel(Labels.CriticalDesignMonth.instructionsLine4, 
				font, textLeft, yStart + 4*yDelta, width, height));
		addLabel(new TranslatableLabel(Labels.CriticalDesignMonth.instructionsLine5, 
				font, textLeft, yStart + 5*yDelta, width, height));
		addLabel(new TranslatableLabel(Labels.CriticalDesignMonth.instructionsLine6, 
				font, textLeft, yStart + 6*yDelta, width, height));
