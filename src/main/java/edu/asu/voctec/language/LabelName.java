...
public class LabelName
{
	...
	public static final LabelName				startButton			= new LabelName(
																			"startButton",
																			"Start");
	public static final LabelName				optionsButton		= new LabelName(
																			"optionsButton",
																			"Options");
	public static final LabelName				replayButton		= new LabelName(
																			"replayButton",
																			"Replay");
	public static final LabelName				returnButton		= new LabelName(
																			"returnButton",
																			"Return");
